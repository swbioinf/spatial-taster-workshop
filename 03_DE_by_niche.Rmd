...
# O uses only *this* cell, and 0.8 recormended for domain  (niche) finding
lamdas      <- c(0.6) 
...
We won't be able to test niches 6 or 8. But the belwo code will test for the number of available conditions per side, and skip them automatically.
