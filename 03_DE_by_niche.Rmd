...
Like when conducting [differential expression by cell type](02_DE_by_celltype.html), we need to create a cell-level annotation for the pseudobulk grouping in our analysis, but this time by niche. We do this by concatenating the tissue sample ID with the niche; here we call this column `pdb_sample`.
