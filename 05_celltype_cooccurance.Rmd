...
**Are myeloid cells migrating closer to the epithalia cells in chrones disease?**
...
spicy_res <- spicy(
  ...
  sigma     = 50, # tissue is not homogenous see: https://www.bioconductor.org/packages/release/workflows/vignettes/spicyWorkflow/inst/doc/spicyWorkflow.html#14_spicyR:_Test_spatial_relationships
  condition = "group",
  from      = "epi",
  to        = "myeloids"
)
...
And there is a very nice visualisation. The size of the circle scales with significants, and the colour indicates the magnitude of the 'L' Value. 
