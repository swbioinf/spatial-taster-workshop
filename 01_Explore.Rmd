...
This data is subsetted to only 4 'Fields of View' (FOV). On the cosmx platform, these are multiple rectangular regions (fields of view) that make up the run. Essentially we're looking at a corner of each sample.
...
Lets check them out on the actual tissue.

A note on the tissue morphology: Here the top would be the lumen of the colon, and a stromal layer at the bottom. The oval-shaped epithelial layers are crypts, and that region is called the lamina propria. See: https://www.pathologyoutlines.com/topic/colon histology.html
